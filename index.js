    ...
    this.answers = [
      ...
      },
      {
        ...
        output: {
          ...
          media: [
            { altText: 'Botium Logo', mediaUri: 'https://cyara.com/wp-content/uploads/2020/03/logo.png' }
          ],
          nlp: {
            intent: {
              name: 'picture',
          ...
          cards: [
            {
              ...
              image: { mediaUri: 'https://cyara.com/wp-content/uploads/2020/03/logo.png' },
              buttons: [
                { text: 'First Button' },
                { text: 'Second Button' }
              ]
...
<p><s>This is sentence one.</s><s>This is sentence two.</s></p>
      ...
      },
      {
        input: ['SSML'],
        output: (msg, session) => ({
          messageText: '<speak>Pure speak</speak>'
        })
      },
      {
        input: ['SSML, audio'],
        output: (msg, session) => ({
          messageText: '<speak><audio src=\'xxx\'><Audio in speak</audio></speak>'
        })
      },
      {
        input: ['HTML'],
        output: (msg, session) => ({
          messageText: '<html><h1>Hello Header!</h1><b>Hello World!</b></html>'
        })
      }
    ]
    this.echoDelay = 0
